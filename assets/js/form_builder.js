$(document).ready(function () {
    ...
    function getPreview(output_string = '') {
        ...
        el.each(function () {
            ...
            if (data_type === 'text') {
				...
				json_string += '{"type": "text", "name": "' + name + '", "label": "' + label + '","placeholder": "' + placeholder + '","required": "' + required + '"},';
            }
            if (data_type === 'number') {
                var placeholder = $(this).find('.form_input_placeholder').val();
                var checkbox = $(this).find('.form-check-input');
				...
				json_string += '{"type": "number","name": "' + name + '", "label": "' + label + '","placeholder": "' + placeholder + '","required": "' + required + '"},';
			}
            if (data_type === 'email') {
                var placeholder = $(this).find('.form_input_placeholder').val();
                var checkbox = $(this).find('.form-check-input');
				...
				json_string += '{"type": "email","name": "' + name + '", "label": "' + label + '","placeholder": "' + placeholder + '","required": "' + required + '"},';
			}
            if (data_type === 'password') {
				...
				json_string += '{"type": "password","name": "' + name + '", "label": "' + label + '","placeholder": "' + placeholder + '","required": "' + required + '"},';
			}
            if (data_type === 'textarea') {
				...
				json_string += '{"type": "textarea","name": "' + name + '", "label": "' + label + '","placeholder": "' + placeholder + '","required": "' + required + '"},';
            ...
            if (data_type === 'date') {
				...
				json_string += '{"type": "date","name": "' + name + '", "label": "' + label + '","required": "' + required + '" },';
			}
            if (data_type === 'button') {
				...
				json_string += '{"type": "button","name": "' + name + '", "label": "' + btn_value + '", "class": "' + btn_class + '" },';
			}
            if (data_type === 'select') {
                var option_html = '';
				var option_json = '';
                $(this).find('select option').each(function () {
					...
					option_json += '{"option": "' + option + '", "value": "' + value + '"},';
                });
				...
				json_string += '{"type": "select","name": "' + name + '", "label": "' + label + '", "options":[' + option_json + ']},';
			}
            if (data_type === 'radio') {
                var option_html = '';
				var option_json = '';
				...
				json_string += '{"type": "radio","name": "' + name + '", "label": "' + label + '", "options":[' + option_json + ']},';
			}
            if (data_type === 'checkbox') {
                ...
                html += '<div class="form-group"><label class="control-label">' + label + '</label>' + option_html + '</div>';
				json_string += '{"type": "checkbox", "name": "' + name + '", "label": "' + label + '", "options":[' + option_json + ']},';
			}
        ...
        if (output_string === 'plain_html') {
            $('.preview').hide();
            $('.plain_html').show().find('textarea').val(html);
        } 
		else if (output_string === 'json') {
            $('.preview').hide();
			/*alert('{"items":[' + json_string + ']}');*/
            var json_str = '[' + json_string + ']';
            var clean_json_str = json_str.replace(/[,]]/g, ']');
            alert(clean_json_str);
            $('.plain_html').show().find('textarea').val(clean_json_str);
        } 
